#!/usr/bin/python
import roslib; roslib.load_manifest('localisation_sonar')
import rospy
import sys
import serial
import time
...
from localisation_sonar.msg import sonar_data
...
def detectObstacle():
    ...
    pub = rospy.Publisher('sonar_info', sonar_data)
    rospy.spin()
